  ...
  return (
    <>
      ...
      <nav
          ...
          } lg:ml-0 w-[270px] sm:w-[312px] transition-all duration-300 ease-out z-20 fixed bg-white flex flex-col border-r p-3 md:p-10 min-h-screen shadow-lg lg:shadow-none overflow-y-auto max-h-screen`}>
          <div className="grow">
            <Link
              href="/"
            ...
            <span className="text-xs">Driver Pages</span>
            <ul className="py-5">             
              <li>
                <Link
                  href="/vendor-notifications"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-notifications" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-evaluation" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-bookings" ? "bg-custom text-white" : ""
                  }`}>
                  <Image src={Dashboard} alt="logo" className="w-7 h-7"/>
                  Statistiques
                </Link>
              </li>
              <li>
                <Link
                  href="/vendor-facture"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-facture" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-activities" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-listings" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-earnings" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-business" ? "bg-custom text-white" : ""
                  }`}>
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path === "/vendor-settings" ? "bg-custom text-white" : ""
                  }`}>
