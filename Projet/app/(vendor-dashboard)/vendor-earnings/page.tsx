...
const Page = () => {
 const scrollRef = useRef<HTMLDivElement>(null);
  ...
  return (
    <div className="rounded-2xl bg-white shadow-3 grid grid-cols-12">
      ...
      <div className="col-span-12 min-[1024px]:col-span-6 xl:col-span-8">
        ...
        <div
          className="max-h-[600px] scrollbar-hide bg-[#EAEBFD] p-4 overflow-y-auto"
          style={{ overflowY: "auto" }}
          ref={scrollRef}>
          <ul className="flex flex-col gap-6">
            <li>
        ...
        <div className="p-4 flex items-center flex-wrap gap-4">
          ...
          <div className="flex items-center flex-grow p-2 border border-neutral-30 bg-[var(--bg-2)] rounded-full">
            ...
            <div className="grid place-content-center w-10 h-10 rounded-full border-1 bg-primary text-black shrink-0">
            <button
              type="button">
