        ...
        <nav
          ...
          <div className="grow">
            ...
            <ul className="py-5">
              <li>
                <Link
                  href="/conducteur2-listings"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path == "/conducteur2-listings" && "bg-primary text-white"
                  }`}>
              ...
              <li>
                <Link
                  href="/conducteur2-bookings"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path == "/conducteur2-bookings" && "bg-primary text-white"
                  }`}>
              ...
              <li>
                <Link
                  href="/conducteur2-activities"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path == "/conducteur2-activities" && "bg-primary text-white"
                  }`}>
              ...
              <li>
                <Link
                  href="/conducteur2-earnings"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path == "/conducteur2-earnings" && "bg-primary text-white"
                  }`}>
              ...
              <li>
                <Link
                  href="/conducteur2-reviews"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path == "/conducteur2-reviews" && "bg-primary text-white"
                  }`}>
              ...
              <li>
                <Link
                  href="/conducteur2-settings"
                  className={`flex items-center gap-2 rounded-md px-6 py-3 duration-300 ${
                    path == "/conducteur2-settings" && "bg-primary text-white"
                  }`}>
